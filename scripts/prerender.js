/**
 * Optional Playwright prerender (local only).
 * Production SEO shells are generated by `scripts/inject-seo-html.js` (works on Vercel).
 * Run manually: npm run prerender
 */
...
if (process.env.VERCEL || process.env.SKIP_PRERENDER === "1") {
    console.log("Skipping prerender (Vercel / SKIP_PRERENDER). Use inject-seo-html.js instead.");
    process.exit(0);
}
